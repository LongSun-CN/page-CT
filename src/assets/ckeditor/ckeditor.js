...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            ...
            basePath: function () {
                ...
                // console.warn('ckeditor base path ', b);
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, l = {
            lt: "\x3c",
            gt: "\x3e",
            amp: "\x26",
            quot: '"',
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var p = "\x3c" + l + "\x3e", m = "\x3c/" + l + "\x3e", c = p + c.replace(d, function () {
                            return m + p
                        }) + m
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var e = this.$.getBoundingClientRect(), g = f.$.documentElement, p = g.clientTop || d.$.clientTop || 0, w = g.clientLeft || d.$.clientLeft || 0, h = !0;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, D = c.endOffset, u, k = this.guard, q = this.type, n = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var y = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), g = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(D) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !y.equals(a)) && (!g || !a.equals(g)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var h = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), G = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), h = CKEDITOR.dom.walker.bookmark(), l = CKEDITOR.dom.walker.temp(), m = function (a) {
        ...
        var f = CKEDITOR.dom.walker.empty(), D = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
            var b = {}, c;
    ...
    (function () {
        ...
        var g = {
            ...
            u: 1,
            "var": 1
        }, h = CKEDITOR.dom.walker.bogus(), l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, m = CKEDITOR.dom.walker.editable(), r = CKEDITOR.dom.walker.ignored(!0);
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, P, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), B = null, I = function (a) {
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, p = this.endContainer, g = this.startOffset, h = this.endOffset, l = 1, u = 1;
    ...
    (function () {
        ...
        function D(a) {
            var b = a.config, c = b.plugins, d = b.extraPlugins, e =
                b.removePlugins;
            if (d)var k = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(k, ""), c = c + ("," + d);
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, h, l) {
                ...
                var x = new CKEDITOR.htmlParser, p = h instanceof CKEDITOR.htmlParser.element ? h : "string" == typeof h ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, w = [], H = [], v = p, u = "textarea" == p.name, k = "pre" == p.name;
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), h = this.rules, l = h.length, m, r, f, D;
    ...
    (function () {
        ...
        function p(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
                {id: 1}), k = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g, d = [/<script[\s\S]*?(<\/script>|$)/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d);
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = p(c, b), c = f(c, Q), c = r(c), c = f(c, Z), c = c.replace(O, "$1cke:$2"), c = c.replace(I, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
        ...
        var J = /<(a|area|img|input|source)\b([^>]*)>/gi, G = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i, Z = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, h) {
            var l = this.container, m = this.ui.space("contents"), r = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
            ...
            return function (m, C, B, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    if (L) {
                        ...
                        var S, X;
                        C = v.startContainer;
                        var K = m.endPath.elements[0], Y, F = K.getPosition(C), D = !!K.getCommonAncestor(C) && F != CKEDITOR.POSITION_IDENTICAL && !(F & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        C = b(m.dataWrapper, m);
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(), k = e.contains(CKEDITOR.dtd.$list), g = f.contains(CKEDITOR.dtd.$list);
                    ...
                    function a(c) {
                        var e = [], f, k = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d), n = c.endPath().contains(d), h = {};
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, k = CKEDITOR.document, g = e.editable(), q = f.getBody(), l = f.getDocumentElement(), m = g.isInline(), p, B;
    ...
    (function () {
        ...
        function z(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = k(this)[a.getName()], f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g;
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, h = c[d ? "endContainer" : "startContainer"], l = d ? "endOffset" : "startOffset", m = g ? c.document.getById(a.startNode) : a.startNode;
    ...
    CKEDITOR.plugins.add("colorbutton", {
        requires: "panelbutton,floatpanel", init: function (d) {
            function r(a, f, c, e, h) {
                var m = new CKEDITOR.style(k["colorButton_" + f + "Style"]), l = CKEDITOR.tools.getNextId() + "_colorBox";
                h = h || {};
    ...
    (function () {
        ...
        var h = h + (' onmouseover\x3d"CKEDITOR.tools.callFunction({hoverFn},{index});" onmouseout\x3d"CKEDITOR.tools.callFunction({moveOutFn},{index});" ' + (CKEDITOR.env.ie ? 'onclick\x3d"return false;" onmouseup' : "onclick") + '\x3d"CKEDITOR.tools.callFunction({clickFn},{index}); return false;"\x3e'), r = CKEDITOR.addTemplate("menuItem", h + '\x3cspan class\x3d"cke_menubutton_inner"\x3e\x3cspan class\x3d"cke_menubutton_icon"\x3e\x3cspan class\x3d"cke_button_icon cke_button__{iconName}_icon" style\x3d"{iconStyle}"\x3e\x3c/span\x3e\x3c/span\x3e\x3cspan class\x3d"cke_menubutton_label"\x3e{label}\x3c/span\x3e{shortcutHtml}{arrowHtml}\x3c/span\x3e\x3c/a\x3e\x3cspan id\x3d"{id}_description" class\x3d"cke_voice_label" aria-hidden\x3d"false"\x3e{ariaShortcut}\x3c/span\x3e\x3c/span\x3e'),
            t = CKEDITOR.addTemplate("menuArrow", '\x3cspan class\x3d"cke_menuarrow"\x3e\x3cspan\x3e{label}\x3c/span\x3e\x3c/span\x3e'), n = CKEDITOR.addTemplate("menuShortcut", '\x3cspan class\x3d"cke_menubutton_label cke_menubutton_shortcut"\x3e{shortcut}\x3c/span\x3e');
    ...
    (function () {
        ...
        CKEDITOR.plugins.copyformatting = {
            ...
            commands: {
                copyFormatting: {
                    exec: function (a, b) {
                        var e = CKEDITOR.plugins.copyformatting, d = a.copyFormatting, c = b ? "keystrokeHandler" == b.from : !1, g = b ? b.sticky || c : !1, f = e._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
                    ...
                    exec: function (a, b) {
                        ...
                        b.from : !1, c = CKEDITOR.plugins.copyformatting, g = a.copyFormatting, f = c._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
            ...
            _convertElementToStyleDef: function (a) {
                var b = CKEDITOR.tools, e = a.getAttributes(CKEDITOR.plugins.copyformatting.excludedAttributes), b = b.parseCssText(a.getAttribute("style"), !0, !0);
                ...
                onClick: function (b) {
                    ...
                    if (c && b != c) {
                        ...
                        if (e.collapsed) {
                            ...
                            if (h) {
                                var g = e.checkBoundaryOfElement(h, CKEDITOR.START), l = e.checkBoundaryOfElement(h, CKEDITOR.END);
                                if (g && l) {
                        ...
                        20: {
                            refresh: function (a, b) {
                                ...
                                if (this.enterBr || this.getContext(b)) {
                                    if (d) {
                                        var c = d, e = e.$.className.match(this.classNameRegex), f = this.isIndent, c = e ? f ? e[1] != c.slice(-1) : !0 : f;
                                        return c ? n : k
                                    }
